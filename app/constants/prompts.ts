...
export const prompts: OpenAI.Chat.Completions.ChatCompletionMessageParam[] = [
  {
    ...
    특정 재료나 소스가 포함된 음식일 경우, 재료나 소스의 이름을 생략하고 음식 이름만 추천해 주세요. 예를 들어, '쯔유 냉우동' 대신 '냉우동'이라고 추천해 주세요.
    `,
  },
  {
    role: "user",
  ...
  {
    role: "assistant",
    content: `{"foods": ["떡볶이", "낚지볶음","닭발", "짬뽕","라면"]}`,
  },
  {
    role: "user",
  ...
  {
    role: "assistant",
    content: `{"foods": ["요거트", 샐러드", "오트밀", "그릴드 치킨", "스무디"]}`,
  },
];
